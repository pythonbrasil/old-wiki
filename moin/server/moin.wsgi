...
sys.path.insert(0, '/var/www/.virtualenvs/wiki.python.org.br/lib/python2.7/site-packages')

# a2) Path of the directory where wikiconfig.py / farmconfig.py is located.
#     See wiki/config/... for some sample config files.
#sys.path.insert(0, '/path/to/wikiconfigdir')
sys.path.insert(0, '/srv/wiki.python.org.br/www/moin/config')
...
log.load_config('/srv/wiki.python.org.br/www/moin/config/logging/logfile')
